...
export function marqueeSelection(hitNodeIds: readonly string[], hitEdgeIds: readonly string[], base: { nodeIds: ReadonlySet<string>; edgeIds: ReadonlySet<string>; } | null): {
    nodeIds: Set<string>;
    edgeIds: Set<string>;
} {
    if (!base) {
